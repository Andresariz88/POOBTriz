...
public class PanelTetrizMulti extends JPanel implements KeyListener {
	...
	public PanelTetrizMulti(POOBTriz juego, String nombre, Color color, POOBTriz juego2, String nombre2, Color color2, int vel) {
		this.juego1 = juego;
		this.nombre1 = nombre;
		colorTablero1 = color;
		normal = vel;
		juego.retrasoMov = vel;
		juego2.retrasoMov = vel;
		this.juego2 = juego2;
	...
	public void guardar() {
		...
		try {
			...
			new FileOutputStream("datamulti.dat") );
			escribiendoFichero.writeObject(juego1);
			escribiendoFichero.writeObject(nombre1);
			escribiendoFichero.writeObject(colorTablero1);
			escribiendoFichero.writeObject(juego2);
			escribiendoFichero.writeObject(nombre2);
			escribiendoFichero.writeObject(colorTablero2);
	...
	public void abrir() {
    	...
    	try {
			leyendo = new ObjectInputStream(new FileInputStream("datamulti.dat"));
	...
	public void keyPressed(KeyEvent e) {
		...
		if (juego2.getState() == POOBTriz.IN_GAME) {
			if (e.getKeyCode() == KeyEvent.VK_DOWN && (juego2.getBuffoActual() == null || juego2.getBuffoActual() instanceof BuffoStopDiece || juego2.getBuffoActual() instanceof BuffoStopTime)) {
				juego2.retrasoMov = rapido;
